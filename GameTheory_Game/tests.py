...
#         temp2 = []
#         temp_eq = 0
#         for stratis in range(shape2):
#             temp_eq += sym[stratis]
#         temp_eq -= 1
#         #strats = [x1+x2+x3+x4-1]
#         strats = [temp_eq]
#         strats2 = [x1+x2+x3+x4-1]
#         for strat in supp2:
#             strats.append(func2[0][strat])
#         for strat in supp:
#             strats2.append(func1[0][strat])
#         for i in range(len(sym)-1):
#             if i not in supp:
#                 strats.append(sym[i])
#             if i not in supp2:
#                 strats2.append(sym[i])
...
#         if solu and solu2:
#             for key in solu[0]:
#                 if (solu[0][key] < 0 and key != w) or (solu2[0][key] < 0 and key != w):
#                     solution = False
#         if solution:
#             temp.append(solu)
#             temp.append([supp, supp2])
#             temp2.append(solu2)
#             temp2.append([supp, supp2])
...
#             temp_funcs2.append(func1[0][i])
#     if temp_funcs:
#         temp_funcs.append(x1+x2+x3+x4-1)
#         for symb in sym:
#             if symb != w and sol[0][1]:
#                 temp_funcs.append(symb-sol[0][1][0][symb])
#     if temp_funcs2:
#         temp_funcs2.append(x1+x2+x3+x4-1)
#         for symb in sym:
#             if symb != w and sol[1][1]:
...
#     optimal = False
#     if sol[0][1] and other_sol and sol[1][1] and other_sol2:
#         if sol[0][1][0][w] >= other_sol[0][w] and sol[1][1][0][w] >= other_sol2[0][w]:
#             optimal = True
#     if optimal:
#         print(sol[0][0], sol[0][1])
#         print(sol[1][0], sol[1][1])
#         print(sol[0][2], sol[1][2])
#         print(other_sol[0][w], sol[0][1][0][w])
#         print(other_sol2[0][w], sol[1][1][0][w])
#         print(temp_funcs)
#         print(temp_funcs2)
#         values.append([sol[0][1][0][w], sol[1][1][0][w]])
